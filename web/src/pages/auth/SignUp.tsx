  ...
  return (
    <div className="w-full">
      ...
      <p className="mt-6 border-t border-border pt-5 text-center text-sm text-muted-foreground">
        ...
        <Link to="/sign-in" className="font-medium text-foreground transition-colors hover:underline underline-offset-4">
          Sign in
        </Link>
      </p>

      <p className="mt-5 text-center text-[11px] text-muted-foreground">Free to start. No credit card required.</p>
    </div>
  );
}
